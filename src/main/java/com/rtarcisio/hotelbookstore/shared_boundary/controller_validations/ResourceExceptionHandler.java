package com.rtarcisio.hotelbookstore.shared_boundary.controller_validations;

import com.rtarcisio.hotelbookstore.shared_boundary.exceptions.*;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> handleAccessDenied(AccessDeniedException ex) {
        StandardError error = new StandardError(HttpStatus.FORBIDDEN.value(),  ex.getMessage());
    ...
    public ResponseEntity<StandardError> handleNotFound(NoHandlerFoundException e, HttpServletRequest request) {
        StandardError error = new StandardError(HttpStatus.NOT_FOUND.value(), "Rota não encontrada: " + e.getRequestURL());
    ...
    public ResponseEntity<StandardError> resourceForbidden(ResourceForbiddenException e, HttpServletRequest request) {
