package com.rtarcisio.hotelbookstore.shared.utils;

import com.rtarcisio.hotelbookstore.auth.domains.AuthUser;
import com.rtarcisio.hotelbookstore.shared.exceptions.AuthenticationException;
...
public final class SecurityUtils {
    ...
    public static String getSubjectOrThrow() {
        return getSubject()
                .orElseThrow(() -> new IllegalStateException("Nenhum subject disponível no contexto de segurança"));
    }
