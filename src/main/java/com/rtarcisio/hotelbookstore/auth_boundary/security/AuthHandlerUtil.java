...
import com.rtarcisio.hotelbookstore.shared_boundary.dtos.ApplicationProperties;
...
public class AuthHandlerUtil {
    ...
    public void authenticateUser(AuthUser user, boolean isSoccial, HttpServletResponse response) throws IOException {
        try {
    ...
    public void setSpringAuthentication(AuthUser user) {
